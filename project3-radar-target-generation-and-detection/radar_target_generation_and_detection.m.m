...
doopler_range_fft = fft2(Mix,Nr,Nd);

% Taking just one side of signal from Range dimension.
doopler_range_fft = doopler_range_fft(1:Nr/2,1:Nd);
doopler_range_fft = fftshift (doopler_range_fft);
doopler_range_fft = abs(doopler_range_fft);
RDM = 10*log10(doopler_range_fft) ;
